                ...
                <div class="container" align="center">
                    ...
                    <table>
                        ...
                        <tr align="center" style="border-color: white;">
                            ...
                            <td><?php echo e($student->usertype); ?></td>
                            <?php if(!$student->usertype): ?>
                            <td>
                                <a class="btn btn-primary" href="<?php echo e(url('updatestudentview',$student->id)); ?>">Edytuj</a>
                            </td>
                            <td>
                                <a class="btn btn-danger" href="<?php echo e(url('deletestudent',$student->id)); ?>">Usuń</a>
                            </td>
                            <?php endif; ?>
                        </tr>
...
</html><?php /**PATH /Users/magdalenan/laravel_proj/project/resources/views/opiekun/showstudent.blade.php ENDPATH**/ ?>