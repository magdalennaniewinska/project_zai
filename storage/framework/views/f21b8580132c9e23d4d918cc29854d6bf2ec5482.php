      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="container-fluid page-body-wrapper">
            <div class="container" align="center">
                ...
                <div style="padding:15px;">
                    <label>Tag</label>
                    <input style="color:black" type="text" name="tag" value="<?php echo e($data->tag); ?>">
                </div>
                <div style="padding:15px;">
                    <label>Model</label>
                    <input style="color:black" type="text" name="model" value="<?php echo e($data->model); ?>">
                </div>
                <div style="padding:15px;">
                    <label>Opis</label>
                    <input style="color:black" type="text" name="description" value="<?php echo e($data->description); ?>">
                </div>
                <div style="padding:15px;">
                    <label>Ilość</label>
                ...
                <div style="padding:15px;">
                    ...
                    <input style="color:black" type="text" name="link" value="<?php echo e($data->link); ?>">
                </div>
                <div style="padding:15px;">
                    <label>Link do zdjęcia produktu</label>
                    <input style="color:black" type="text" name="image" value="<?php echo e($data->image); ?>">
                </div>
                <div style="padding:15px;">
...
<?php /**PATH /Users/magdalenan/laravel_proj/project/resources/views/opiekun/updateview.blade.php ENDPATH**/ ?>